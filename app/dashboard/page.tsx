  ...
  if (error) {
    return (
      <div className="flex flex-col justify-center items-center min-h-screen">
        ...
        <button 
          className="mt-4 bg-yellow-400 text-blue-900 px-6 py-2 rounded-lg font-semibold hover:bg-yellow-500"
    ...
    <div className="p-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="flex items-center">
          ...
          <span className="ml-2 text-2xl font-semibold text-blue-900">Pi</span>
        </div>
        
        <div className="mt-6 space-x-4">
          <button 
            className="bg-yellow-400 text-blue-900 px-6 py-2 rounded-lg font-semibold hover:bg-yellow-500 transition-all duration-200 transform hover:scale-105"
            onClick={handleSend}
          >
            Send
          </button>
              ...
              <tbody>
                {transactions.map((tx) => (
                  <tr key={tx.id} className="border-b">
                    <td className="px-6 py-4">{new Date(Date.parse(tx.timestamp)).toLocaleDateString()}</td>
